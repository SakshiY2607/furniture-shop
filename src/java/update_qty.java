...
public class update_qty extends HttpServlet {
        ...
        PrintWriter out = response.getWriter();
         ...
         String qty =request.getParameter("quantity");
          ...
          try {
                ...
                if(qty.equals("0")){
                     ps = con.prepareStatement("delete from cart where cart_id='"+cart_id+"'");
                
                }else{
                 ps = con.prepareStatement("update cart set pro_qty ='"+qty+"' where cart_id='"+cart_id+"'");
                }
