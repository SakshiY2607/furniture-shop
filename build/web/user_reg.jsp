            ...
            <div class="card card-3">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="user_reg">
                        ...
                        <div class="input-group">
                            <input class="input--style-3" type="password" placeholder="Confirm Password" name="cpass">
                        </div>
                        <div class="input-group">
                            <input class="input--style-3" type="number" placeholder="Phone" name="contact">
                        </div>
                        <div class="input-group">
                     ...
                     <div class="p-t-10">
                        <a class="text-white" style="font-size: 16px; text-align: center;" href="index.jsp">Log In</a>
                        </div>
                </div>
            </div>
        </div>
